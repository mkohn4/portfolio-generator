...
const generateProjects = projectsArr => {
    //short form way of accomplishing
    return `
  ...
  `;
    ...
    //long form way of accomplishing
    ...
    //get array of all non-features projects
...
const generatePage = templateData => {
    ...
    //create variables to hold project data vs. about data and everything else as the header
